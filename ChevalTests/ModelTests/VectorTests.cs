...
namespace ChevalTests.ModelTests
{
    ...
    public class VectorTests
    {
        ...
        public double MagnitudeTest(double x, double y, double z)
        {
            ...
            //Act
            return ChevalVector.Magnitude(test);
        }
       ...
       [Test]
        ...
        public void Magnitude_of_normalized_vector_is_one()
        {
            ...
            //Act
            var norm = ChevalVector.Normalize(v1);
            var result = ChevalVector.Magnitude(norm);
            //Assert
            result.Should().Be(1);
        }
        /*
        ...
        public void Dot_product_test()
        {
            ...
            //Act
            var result = ChevalVector.Dot(a, b);
            //Assert
            result.Should().Be(20);
        }
        /*
        ...
        public void Cross_product_tests()
        {
            ...
            var result1 = ChevalVector.Cross(a, b);
            var expected2 = new ChevalVector(1,-2,1);
            var result2 = ChevalVector.Cross(b, a);
            //Assert
            result1.Should().BeEquivalentTo(expected1);
            result2.Should().BeEquivalentTo(expected2);
        }
